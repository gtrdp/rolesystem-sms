...
<div class="row marketing">
  ...
  <div class="col-lg-6">
    ...
    <p>There are total</p>
    <p class="lead">253 <small>numbers.</small></p>

    <h4>SMS Count</h4>
    <p>Cumulative SMS count is</p>
    <p class="lead">1,876 <small>SMS.</small></p>

    <h4>Total Balance</h4>
    <p>This system has spent</p>
    <p class="lead"><small>Rp</small> 1,240,000 <small>,00.</small></p>
  </div>

  <div class="col-lg-6">
    <h4>Total Cases</h4>
    <p>This system contains nearly</p>
    <p class="lead"> 24 <small>cases</small>.</p>

    <h4>Case Solved</h4>
    <p>This system has successfully solved.</p>
    <p class="lead"> 437 <small>cases</small>.</p>

    <h4>SPAM Counter</h4>
    <p>The number of SPAM encountered</p>
    <p class="lead"> 37 <small>and counting</small>.</p>
  </div>
</div>